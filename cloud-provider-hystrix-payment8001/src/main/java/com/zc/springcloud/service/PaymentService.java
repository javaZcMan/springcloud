...
public class PaymentService {
    ...
    public String paymentInfo_Ok(Integer id) {
        ...
        return "线程:" + Thread.currentThread().getName() + "OKid:" + id;
    }
    ...
    public String paymentInfo_Out(Integer id) {
        ...
        //int age = 10/0;
        return "线程:" + Thread.currentThread().getName() + "Outid:" + id;
    }

    public String paymentInfo_OutHandler(Integer id){

        return "服务端系统繁忙，请稍后再试:"+id;
    }
    ...
    @HystrixCommand(fallbackMethod = "paymentCircuitBreaker_fallback",commandProperties = {
            ...
            @HystrixProperty(name = "circuitBreaker.sleepWindowInMilliseconds",value = "10000"),//服务熔断后的休眠时间
